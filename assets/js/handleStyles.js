function setupStyles(tint_user_settings) {
    ...
    const bottom_cta = document.querySelectorAll('.paragraph--type--tint-component .bottom_cta');
    ...
    post_overlay.forEach(postTeaser => {
        ...
        postTeaser.querySelector('.slide-overlay p').style.color = overlay_text_color;
    });
    ...
    popup_text_content.forEach(content => {
        ...
        const contentSmall = content.querySelector('.content_description_main');
        const contentLarge = content.querySelector('.content_description_additional');

        contentSmall.style.color = popup_text_color; 
        contentLarge.style.color = popup_text_color;     
